...
## What is Intel® AI Enterprise Solutions?
...
Intel® AI Enterprise Solutions wires these pieces together in a pre-integrated, customizable Kubernetes stack optimized for Intel® Xeon® processors.
...
|:---:|:---:|
| ![Keycloak login screen for Intel AI Enterprise Solutions, showing OIDC-based sign-in used for identity and access management](docs/assets/screenshots/keycloak-auth.png) | ![Grafana dashboard for Intel AI Enterprise Solutions showing vLLM inference metrics: request rate, latency, time-to-first-token, and token throughput](docs/assets/screenshots/grafana-dashboard.png) |
...
- [Meet AI Enterprise Solutions](docs/meet/meet.md)
